...
const version='20260915-context1';
...
for(const file of ['app.js','urban-context.js']){let code=fs.readFileSync(file,'utf8');code=code.replace(/from '(\.\/[^'?]+\.js)(?:\?[^']*)?'/g,(_,name)=>`from '${name}?v=${version}'`);fs.writeFileSync(file,code)}
